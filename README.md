...
- [x] Recommended: Go through the Flexbox Froggy and Grid Garden resources at the end of this homework.
...
- [ ] Recreate the page `Flexbox Article Layout` as closely as possible. Feel free to use flexbox, or grids, or both if needed. Here [a link to the HTML](https://gist.github.com/gstark/67f00631b3efe6145d34f9bfdf082637)
